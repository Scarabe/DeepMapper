...
public class GoogleConstants {
	public static final String googleLink = "http://www.google.com";
	public static final String serchBtnName = "btnK";
	...
	public static final String serchContent = "Onion Links";
}
